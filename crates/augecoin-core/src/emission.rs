...
//
// 315 576 000 blocks × 2.50 AUGE = 788 940 000 AUGE
// ────────────────────────────────────────────────────────────────────────
...
///
/// Every block in the emission period (blocks 0 through 315 575 999)
/// receives exactly 2.50 AUGE = 250 000 000 augesat.
...
mod tests {
    ...
    #[test]
    fn two_point_fifty_auge_times_blocks() {
