//! Request billing middleware (logic also in gateway_mw.rs)
    ...
    let claims = match claims {
        ...
        Err(_) => {
            ...
            return Err(Response::builder()
                ...
                .body(axum::body::Body::from(r#"{"error":"invalid_token","message":"Invalid or expired JWT"}"#))
                .unwrap());
        }
    };
